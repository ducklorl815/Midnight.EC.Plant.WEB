...
public interface IPlantCareRecordRepository
{
    ...
    Task<PlantCareRecord?> FindSameDayAsync(int plantId, DateTime recordDate, CareRecordType careType, CancellationToken cancellationToken = default);
    Task AddAsync(PlantCareRecord record, CancellationToken cancellationToken = default);
    Task UpdateAsync(PlantCareRecord record, CancellationToken cancellationToken = default);
